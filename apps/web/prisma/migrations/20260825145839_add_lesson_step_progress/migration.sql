...
INSERT INTO "new_LessonSession" ("bookingId", "costCents", "endedAt", "finalState", "id", "openExerciseAt", "openExerciseHints", "openExerciseId", "plan", "startedAt", "summary") SELECT "bookingId", "costCents", "endedAt", "finalState", "id", "openExerciseAt", "openExerciseHints", "openExerciseId", "plan", "startedAt", "summary" FROM "LessonSession";
